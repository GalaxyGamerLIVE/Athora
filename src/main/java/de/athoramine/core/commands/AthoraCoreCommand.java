...
public class AthoraCoreCommand extends PluginCommand<Main> {
    public AthoraCoreCommand(Main owner) {
        ...
        this.setPermission("athora.core.de.athoramine.core.api.de.athoramine.core.commands");
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        if (!sender.hasPermission("athora.core.de.athoramine.core.api.de.athoramine.core.commands")) {
